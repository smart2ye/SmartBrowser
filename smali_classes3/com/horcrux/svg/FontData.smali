...
.method constructor <init>(Lcom/facebook/react/bridge/ReadableMap;Lcom/horcrux/svg/FontData;D)V
    ...
    .line 167
    :cond_0
    iput-wide v5, p0, Lcom/horcrux/svg/FontData;->fontSize:D
    ...
    invoke-direct {p0, p2, v2, v3}, Lcom/horcrux/svg/FontData;->handleNumericWeight(Lcom/horcrux/svg/FontData;D)V
    ...
    .line 176
    invoke-static {v2}, Lcom/horcrux/svg/TextProperties$FontWeight;->hasEnum(Ljava/lang/String;)Z
    ...
    .line 177
    invoke-static {v2}, Lcom/horcrux/svg/TextProperties$FontWeight;->get(Ljava/lang/String;)Lcom/horcrux/svg/TextProperties$FontWeight;

    move-result-object v2

    invoke-static {v2, p2}, Lcom/horcrux/svg/FontData$AbsoluteFontWeight;->from(Lcom/horcrux/svg/TextProperties$FontWeight;Lcom/horcrux/svg/FontData;)I
    ...
    :cond_5
    iget-object v2, p2, Lcom/horcrux/svg/FontData;->fontData:Lcom/facebook/react/bridge/ReadableMap;

    :goto_2
    iput-object v2, p0, Lcom/horcrux/svg/FontData;->fontData:Lcom/facebook/react/bridge/ReadableMap;
    ...
    :cond_6
    iget-object v2, p2, Lcom/horcrux/svg/FontData;->fontFamily:Ljava/lang/String;

    :goto_3
    iput-object v2, p0, Lcom/horcrux/svg/FontData;->fontFamily:Ljava/lang/String;
    ...
    invoke-static {v2}, Lcom/horcrux/svg/TextProperties$FontStyle;->valueOf(Ljava/lang/String;)Lcom/horcrux/svg/TextProperties$FontStyle;
    ...
    :cond_7
    iget-object v2, p2, Lcom/horcrux/svg/FontData;->fontStyle:Lcom/horcrux/svg/TextProperties$FontStyle;

    :goto_4
    iput-object v2, p0, Lcom/horcrux/svg/FontData;->fontStyle:Lcom/horcrux/svg/TextProperties$FontStyle;
    ...
    :goto_5
    iput-object v2, p0, Lcom/horcrux/svg/FontData;->fontFeatureSettings:Ljava/lang/String;
    ...
    .line 201
    :cond_9
    iget-object v2, p2, Lcom/horcrux/svg/FontData;->fontVariationSettings:Ljava/lang/String;

    :goto_6
    iput-object v2, p0, Lcom/horcrux/svg/FontData;->fontVariationSettings:Ljava/lang/String;
    ...
    invoke-static {v2}, Lcom/horcrux/svg/TextProperties$FontVariantLigatures;->valueOf(Ljava/lang/String;)Lcom/horcrux/svg/TextProperties$FontVariantLigatures;
    ...
    :goto_7
    iput-object v2, p0, Lcom/horcrux/svg/FontData;->fontVariantLigatures:Lcom/horcrux/svg/TextProperties$FontVariantLigatures;
    ...
    invoke-static {v2}, Lcom/horcrux/svg/TextProperties$TextAnchor;->valueOf(Ljava/lang/String;)Lcom/horcrux/svg/TextProperties$TextAnchor;
    ...
    .line 210
    :cond_b
    iget-object v2, p2, Lcom/horcrux/svg/FontData;->textAnchor:Lcom/horcrux/svg/TextProperties$TextAnchor;

    :goto_8
    iput-object v2, p0, Lcom/horcrux/svg/FontData;->textAnchor:Lcom/horcrux/svg/TextProperties$TextAnchor;
    ...
    invoke-static {v2}, Lcom/horcrux/svg/TextProperties$TextDecoration;->getEnum(Ljava/lang/String;)Lcom/horcrux/svg/TextProperties$TextDecoration;
    ...
    .line 214
    :cond_c
    iget-object v2, p2, Lcom/horcrux/svg/FontData;->textDecoration:Lcom/horcrux/svg/TextProperties$TextDecoration;

    :goto_9
    iput-object v2, p0, Lcom/horcrux/svg/FontData;->textDecoration:Lcom/horcrux/svg/TextProperties$TextDecoration;
    ...
    .line 217
    iget-boolean v3, p2, Lcom/horcrux/svg/FontData;->manualKerning:Z
    ...
    :goto_b
    iput-boolean v3, p0, Lcom/horcrux/svg/FontData;->manualKerning:Z

    if-eqz v2, :cond_f

    .line 222
    iget-wide v5, p0, Lcom/horcrux/svg/FontData;->fontSize:D
    ...
    :cond_f
    iget-wide v5, p2, Lcom/horcrux/svg/FontData;->kerning:D

    :goto_c
    iput-wide v5, p0, Lcom/horcrux/svg/FontData;->kerning:D
    ...
    .line 226
    :cond_10
    iget-wide v5, p2, Lcom/horcrux/svg/FontData;->wordSpacing:D

    :goto_d
    iput-wide v5, p0, Lcom/horcrux/svg/FontData;->wordSpacing:D
    ...
    :goto_e
    iput-wide v1, p0, Lcom/horcrux/svg/FontData;->letterSpacing:D
